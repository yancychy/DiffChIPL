...
usethis::use_git_config(user.name = "yancychy", user.email = "yancychy@163.com")

## create a personal access token for authentication:
usethis::create_github_token() 
## in case usethis version < 2.0.0: usethis::browse_github_token() (or even better: update usethis!)

## set personal access token: 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
credentials::set_github_pat("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")
